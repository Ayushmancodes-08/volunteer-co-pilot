        ...
        <div className="mt-8 pt-6 border-t border-slate-100 space-y-4">
          ...
          <div className="flex justify-between items-center bg-indigo-50/50 rounded-xl p-3 border border-indigo-100/40">
            <div>
              ...
              <span className="text-xl font-mono font-bold text-indigo-900">{timeLeft}</span>
            </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
            ...
            <div className="flex items-center gap-3">
              <span className="text-sm font-bold text-slate-600">{completedCount}/{tasks.length} ({progressPercent}%)</span>

...
import { VolunteerProfile as IVolunteerProfile, Task } from '../types';

interface VolunteerProfileProps {
  profile: IVolunteerProfile | null;
  onUpdate: (updated: IVolunteerProfile) => void;
  loading: boolean;
}

export default function VolunteerProfile({ profile, onUpdate, loading }: VolunteerProfileProps) {
  const { t } = useI18n();
  ...
  const [timeLeft, setTimeLeft] = useState<string>('07:59:59');
